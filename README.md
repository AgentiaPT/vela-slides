...
>
> Every line of Vela — 21,000+ lines of JSX, Python CLI tools, and build scripts — was generated entirely by AI (Claude). The codebase is validated by extensive AI code reviews, 600+ automated tests, and static analysis, but no human has ever read or audited the code.
>
...
├── tests/
│   ├── test_vela.py           ← Core engine tests (503 tests)
│   └── test_serve.py          ← Server endpoint & security tests (124 tests)

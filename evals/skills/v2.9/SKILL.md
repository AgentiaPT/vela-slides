...
### Command selection
- **Translate/bulk rewrite**: `extract-text` + `patch-text` (2 calls vs N×replace)
...
- **Spacers are bare ints** — `8` not `{"_":"spacer","h":8}`. **Remove multiple slides from highest index first.**

...
// deckToMarkdown (src/parts/part-export-md.jsx) is a pure state->string function
// with zero prior coverage. We eval-extract it under Node (no browser/React/canvas
...
const src = fs.readFileSync(path.join(__dirname, "..", "src/parts/part-export-md.jsx"), "utf8");

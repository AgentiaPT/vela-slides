...
| **PPTX export** | `src/parts/part-pptx.jsx` | `buildPptx`, `pptxEsc`, `pptxExtractTextBoxes` (reuses `part-pdf-extract.jsx`'s extractors); the modal `PptxExportModal` is in `part-app.jsx` |

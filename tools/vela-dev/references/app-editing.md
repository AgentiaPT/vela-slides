...
├── part-imports.jsx    # ~1520L — constants, sanitizers, helpers, storage
...
├── part-list.jsx       #  ~660L — Lane, ConceptRow, AI adder
├── part-chat.jsx       #  ~440L — ChatPanel, tool trace cards
├── part-test.jsx       #  ~330L — VelaBatteryTest
├── part-uitest.jsx     # ~2130L — 206 UI tests in 38 suites
...
The Vela app is ~19,086 lines / ~1.3MB. Editing a monolith that large carries real risks:

| Concern | Monolith | Modular Parts |
|---|---|---|
| str_replace collision risk | High — many similar patterns across 19,086L | Low — part files are ~290–3960L |
...
| Finding what to edit | Grep through 19,086 lines | File name tells you where to look |
...
```bash
python3 tests/test_vela.py          # 410 tests

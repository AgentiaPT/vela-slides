...
const VELA_CHANGELOG = [
  { v: "13.20", d: ["CLI: `vela --capabilities` now lists `deck extract`/`deck init`/`slide append`, existing commands missing from the machine-readable catalog.", "Docs sync: corrected stale line/test counts across README, ARCHITECTURE, DEPENDENCIES, CONTRIBUTING, and internal dev references."] },

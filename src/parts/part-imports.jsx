...
const VELA_CHANGELOG = [
  { v: "13.20", d: ["Security (desktop): the filesystem guard now checks where a path physically leads, not just how it reads, closing a link-following escape from the approved folder.", "Deck listings, opens, saves and new-deck writes are each vetted; a folder you point at another location still works.", "Regression tests added on both the shell and native sides."] },

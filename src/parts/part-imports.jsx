...
const VELA_CHANGELOG = [
  { v: "13.20", d: ["Docs: brought line/test counts in CLAUDE.md, docs/ARCHITECTURE.md and README.md back in sync with the shipped app, and added the missing `deck init`/`deck extract` entries to the CLI capabilities metadata."] },

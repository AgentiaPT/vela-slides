...
const VELA_CHANGELOG = [
  { v: "13.20", d: ["Security (desktop): the filesystem guard now checks where a path actually leads, not just how it reads, closing a link-following escape from the approved folder. Confinement uses Go's standard traversal-resistant file API.", "Deck listings, opens, saves and new-deck writes are each vetted; a folder you point at another location still works.", "Regression tests added on both the shell and native sides."] },

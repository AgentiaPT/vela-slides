...
const VELA_VERSION = "13.51";
const VELA_CHANGELOG = [
  { v: "13.51", d: ["security: the expansion budget is now measured on the parsed deck in bytes, closing ways a deck could be built despite exceeding it", "security: the turbo format is budgeted like the compact one", "fix: a refused deck reports a validation error instead of a traceback"] },

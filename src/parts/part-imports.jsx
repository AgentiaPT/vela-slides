...
const VELA_CHANGELOG = [
  { v: "13.20", d: "Docs sync: corrected stale line/test counts in ARCHITECTURE.md and CLAUDE.md, documented the vela.py CLI commands missing from the reference docs (deck init/extract, slide append), and refreshed the screenshot-testing runbook for the offline render harness." },

...
```
vela deck ship|validate|list|stats|find|dump|split|replace-text|compact|expand|turbo|extract|extract-text|patch-text|assemble|init
vela slide edit|view|remove|move|duplicate|insert|remove-block|append
```

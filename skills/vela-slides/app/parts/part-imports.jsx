...
const VELA_CHANGELOG = [
  { v: "12.69", d: "Security (Medium, audit 2026-06): fix a PDF string literal injection in the canvas (raster) PDF export path. A deck-supplied link URL containing valid RFC 3986 characters that are also PDF string delimiters could break the PDF object boundary and inject adjacent PDF dictionary entries. The vector export path already escaped these correctly; the canvas path now applies the same escaping, bringing both paths into parity. No behavior change for well-formed URLs." },

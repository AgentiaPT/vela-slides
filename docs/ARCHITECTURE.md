...
part-uitest     → UI integration tests (206 tests in 38 suites)
...
| `part-uitest.jsx` | ~2,130 | 206 UI integration tests in 38 suites — comprehensive coverage of block rendering, themes, edge cases |
